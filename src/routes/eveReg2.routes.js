...
import { verifyEventPayment } from "../controllers/eventRegistration.controller.js";
...
router.post("/verify-payment", authenticateUser, verifyEventPayment);
...
// =============================================================================
router.post("/weight_lifting/register",authenticateUser, registerForWeightLifting);
router.get("/weight_lifting/my-registration", authenticateUser, getMyWeightLiftingRegistration);
router.delete("/weight_lifting/cancel", authenticateUser, cancelWeightLiftingRegistration);

router.post(
  "/weight_lifting/create-order",
  authenticateUser,
  createEventOrder("weight_lifting") // pass a machine key
);

router.post(
  "/weight_lifting/verify-payment",
  authenticateUser,
  verifyAndRegister(EVENT_MODELS.weight_lifting, "weight_lifting")
);



// Admin/Moderator routes for Weight Lifting
router.get("/weight_lifting/all", authenticateUser, authorizeRoles("admin", "moderator"), getAllWeightLiftingRegistrations);
router.put("/weight_lifting/:registrationId/status", authenticateUser, authorizeRoles("admin", "moderator"), updateWeightLiftingRegistrationStatus);
